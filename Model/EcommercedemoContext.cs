...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__Address__091C2A1BA88A5951");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Addresses)
                ...
                .HasConstraintName("FK__Address__UserID__7B5B524B");
        });

        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brand__AABC25676A687791");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.Brands)
                ...
                .HasConstraintName("FK__Brand__Category___619B8048");
        });

        modelBuilder.Entity<Category>(entity =>
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__6DB38D6E49155BCA");
        ...
        {
            entity.HasKey(e => e.CouponId).HasName("PK__Coupons__384AF1DAB478D946");

            entity.HasIndex(e => e.Code, "UQ__Coupons__A25C5AA7BA81FE1F").IsUnique();
        ...
        {
            entity.HasKey(e => e.DiscountId).HasName("PK__Discount__6C137204130E905D");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Log__5E54864895944010");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Logs)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__Log__User_Id__628FA481");
        });

        modelBuilder.Entity<Order>(entity =>
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__F1E4607B79468241");
        ...
        {
            entity.HasKey(e => e.ItemId).HasName("PK__OrderIte__727E838BE125B080");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A581DD461BD");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Product__9834FBBA3EA40F6A");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ProductI__3213E83FF05CE502");
            ...
            entity.HasOne(d => d.Discount).WithMany(p => p.ProductItemDetails)
                ...
                .HasConstraintName("FK__ProductIt__Disco__6B24EA82");

            entity.HasOne(d => d.Product).WithMany(p => p.ProductItemDetails)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__ProductIt__Produ__6C190EBB");
        });

        modelBuilder.Entity<Review>(entity =>
        {
            entity.HasKey(e => e.ReviewId).HasName("PK__Reviews__74BC79AEFF8A44AA");

            entity.Property(e => e.ReviewId).HasColumnName("ReviewID");
            entity.Property(e => e.Comment).HasColumnType("text");
            entity.Property(e => e.ProductId).HasColumnName("ProductID");
            entity.Property(e => e.Rating).HasColumnType("decimal(10, 1)");
        ...
        {
            entity.HasKey(e => e.CartId).HasName("PK__Shopping__51BCD7976B952CA7");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.ShoppingCarts)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__ShoppingC__UserI__70DDC3D8");
        });

        modelBuilder.Entity<ShoppingCartItem>(entity =>
        {
            entity.HasKey(e => e.ItemId).HasName("PK__Shopping__727E83EB0171EA8D");
            ...
            entity.HasOne(d => d.Cart).WithMany(p => p.ShoppingCartItems)
                ...
                .HasConstraintName("FK__ShoppingC__CartI__6EF57B66");

            entity.HasOne(d => d.Product).WithMany(p => p.ShoppingCartItems)
                .HasForeignKey(d => d.ProductId)
                .HasConstraintName("FK__ShoppingC__Produ__6FE99F9F");
        });

        modelBuilder.Entity<SubscriptionType>(entity =>
        {
            entity.HasKey(e => e.SubscriptionId).HasName("PK__subscrip__51805A510C1AA86D");
        ...
        {
            entity.HasKey(e => e.SupplierId).HasName("PK__Supplier__83918DB82C2E3103");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Supplier__3213E83F68E30398");
        ...
        {
            entity.HasKey(e => e.SupplierOrderId).HasName("PK__Supplier__BB5F7DD685713220");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Supplier__3213E83FBA78273E");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__206D917064AD4679");

            entity.HasIndex(e => e.Username, "UQ__Users__536C85E4554ABCFF").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Users__A9D105342E5CE551").IsUnique();
        ...
        {
            entity.HasKey(e => e.UserCouponId).HasName("PK__UserCoup__22994B731872CCD8");
            ...
            entity.HasOne(d => d.Coupon).WithMany(p => p.UserCoupons)
                ...
                .HasConstraintName("FK__UserCoupo__Coupo__71D1E811");

            entity.HasOne(d => d.User).WithMany(p => p.UserCoupons)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK__UserCoupo__UserI__72C60C4A");
        });

        modelBuilder.Entity<UserSubscription>(entity =>
        {
            entity.HasKey(e => e.UserSubscriptionId).HasName("PK__UserSubs__D1FD775C5E35C6DE");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserSubscriptions)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__UserSubsc__User___75A278F5");
        });

        modelBuilder.Entity<UserType>(entity =>
        {
            entity.HasKey(e => e.TypeId).HasName("PK__User_typ__FE91E1E670A1BFC9");
        ...
        {
            entity.HasKey(e => e.VendorId).HasName("PK__Vendors__FC8618D3F7425943");
